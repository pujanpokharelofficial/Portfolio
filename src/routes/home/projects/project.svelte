<script lang="ts">
	...
	let { title, description, link, icon } = project;
</script>

<div
	class="project p-standard rounded-md h-max overflow-hidden border-[1px] border-gray-light group hover:bg-gray-extra-light hover:border-gray-dark"
>
	...
	<div class="txt_content text-black-medium mt-standard">
		<h1 class="title text-title font-bold uppercase">{title}</h1>
